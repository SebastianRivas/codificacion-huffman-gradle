...
package org.CodificacionHuffman.app.logica;
...
public class Archivo 
{
    ...
    public void escribirArchivoHuffman(ArrayList <Character> caracteres, ArrayList <String> codigoHuffman) 
    {
        ...
        try 
        {
            rutaArchivoHuffman = "src/main/java/org/CodificacionHuffman/output/text/CodificacionHuffman_" + archivo.getName();
    ...
    public void escribirArchivoAscii() 
    {
        ...
        {
            rutaArchivoHuffman = "src/main/java/org/CodificacionHuffman/output/text/CodificacionHuffman_" + archivo.getName();
            rutaArchivoAscii = "src/main/java/org/CodificacionHuffman/output/text/ASCII_" + archivo.getName();
    ...
    public void escribirInforme(Arbol root, ArrayList <Character> caracteres, ArrayList <String> codigoHuffman) 
    {
        ...
        try 
        {
            rutaInforme = "src/main/java/org/CodificacionHuffman/output/text/Informe_" + archivo.getName();
